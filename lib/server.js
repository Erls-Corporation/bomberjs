...
var Server = exports.Server = function(app) {
  ...
  this.options = {
    ...
    session_cookie_name: this.base.config.session_cookie_name || 'session_key',
    session_expire_minutes: this.base.config.session_expire_minutes || 120
  };
...
Server.prototype.start = function() {
  ...
  http.createServer(function (req, res) {
      try {
        ...
        request.session = response.session = server.session_store.getCurrentSession(request, response);
