...
SessionStore.prototype.getCurrentSession = function(request, server) {  
  ...
  var session_key = request.cookies.getSecure( this._server.options.session.cookie.name );
  if ( !session_key ) {
...
SessionStore.prototype._generateNewSessionKey = function() {
  do {
    ...
    var session_key = sha1.hex_hmac_sha1( rnd, this._server.options.security.signing_secret );
